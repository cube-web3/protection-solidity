...
abstract contract Cube3ProtectionUpgradeable is ProtectionBase {
    ...
    function __Cube3ProtectionUpgradeable_init(address router, address integrationAdmin, bool enabledByDefault) internal {
        __Cube3ProtectionUpgradeable_init_unchained(router, integrationAdmin, enabledByDefault);
    }

    function __Cube3ProtectionUpgradeable_init_unchained(address _router, address _integrationAdmin, bool _enabledByDefault) private {
